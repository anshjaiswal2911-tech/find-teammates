      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className="relative">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl overflow-hidden bg-gradient-to-br from-blue-500 to-purple-500 text-sm font-black text-white shadow-md">
              {user?.profileImage ? (
